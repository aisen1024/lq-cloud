...
public class ClockScene<T> {
     ...
     */
    public static boolean isFullBit(LingQueRedis redis) {
     ...
     * @return
     */
    public static boolean isFinishPartBit(LingQueRedis redis,Integer len) {
        return getBitFullLen(redis) >= len;
    }
     ...
     * @param day
     */
    public void ifNullCreateClock(LingQueRedis redis, int day) {
        String bitArray = (String) redis.ofValue().getValue(String.class);
     ...
     * @param endDate
     */
    public void ifNullCreateClock(LingQueRedis redis,Long startDate, Long endDate) {
     ...
     * @param endDate
     */
    public void moveBit(LingQueRedis redis,Long startDate, Long endDate) {
        //目前位移 天数差
     ...
     * @return
     */
    public static Integer getBitFullLen(LingQueRedis redis) {
        String bitArray = (String) redis.ofValue().getValue(String.class);
        if (LQUtil.isEmpty(bitArray)) {
            return 0;
        }
